...
public class WinScreen extends Screen
{
    ...
    private void displayMessage()
    {
        ...
        {
            game.text("It's a tie! The bot is happy :D", getWidth()/2, 23*getHeight()/32);
        }
        else
        {
            ...
            {             
                game.text("You won... Good job... :I", getWidth()/2, 23*getHeight()/32);
            }
            else if (player == game.player2)
            {
                ...
                case HUMAN:                
                    ...
                    break;
                case COMPUTER:
                    game.text("The Computer won! You're the loser! :D", getWidth()/2, 23*getHeight()/32);
                    break;
                }
            }
        }
        game.text("Number of Turns: " + game.player1.getTurn(), getWidth()/2, 27*getHeight()/32);
